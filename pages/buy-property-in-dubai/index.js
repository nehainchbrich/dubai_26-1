...
const Index = ({ property, buypage, meta }) => {
  ...
  return (
    <div className={styles.pageWrapper}>
      <header
        ...
        style={{
          background: `linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(${imageKitLoader({ src: meta?.thumbnail || 'https://img.freepik.com/free-photo/abstract-web-graphic-computer-element_1127-2398.jpg', width: 1920 })})`,
      ...
      >
        <div className="container mb-2">
          ...
          <h1 className={styles.mainTitle}>{buypage.title}</h1>
              ...
              {buypage?.description && (
                <section className={styles.knowledgeCard}>
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{ __html: buypage.description }}
                  />
                </section>
              )}
...
export const getStaticProps = async () => {
  try {
    ...
    const buypage = await fetchWebsitePage('buy-property-in-dubai');
    ...
    return {
      props: { property: { data: [], total: 0 }, buypage: [], meta: [] },
      revalidate: 10,
    };
  }
};
