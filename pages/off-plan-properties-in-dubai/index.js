  ...
  return (
    <div className={styles.rowCard}>
      ...
      <div className={styles.contentSide}>
        <div className={styles.lifestyleTag}>Exclusive Off-Plan</div>
        <Link href={`/properties/${item.slug}`}>
    ...
    <div className={styles.pageWrapper}>
      ...
      >
        <div className="container mb-2">
          <h1 className={styles.mainTitle}>{offPlanPage.title}</h1>
          <span className={styles.countLabel}>{total.toLocaleString()} Exclusive Off-Plan Projects</span>
          <p className={styles.headerDesc}>Invest in Dubai's future with premium off-plan opportunities</p>
        </div>
      </header>
        ...
        <section className={styles.filterContainer}>
          ...
          <div className={styles.slimMainRow}>
            ...
            <select className={styles.selectUnit}>
              ...
              <option>Villas & Townhouses</option>
              <option>Luxury Apartments</option>
              <option>Waterfront Units</option>
            </select>
            <select className={styles.selectUnit}>
          ...
          <div className={styles.areaStrip}>
            <span className={styles.stripLabel}>Top Localities:</span>
        ...
        <main className="row">
          ...
          <div className="col-lg-3">
            <aside className={styles.editorialSidebar}>
              {offPlanPage?.description && (
                <section className={styles.knowledgeCard}>
                  <h4>Investment Insights</h4>
                  <div
                    className={styles.descText}
                    dangerouslySetInnerHTML={{ __html: offPlanPage.description }}
                  />
                </section>
              )}
...
export const getStaticProps = async () => {
  try {
    ...
    const meta = await fetchData(API_URLS.META, {
      slug: 'off-plan-properties-in-dubai',
    ...
    return {
      props: { property: { data: [], total: 0 }, offPlanPage: [], meta: [] },
      revalidate: 10,
    };
  }
};
